...
**BlackRoad AI** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
> BlackRoad AI — models, agents, inference, training, sovereign AI. Proprietary BlackRoad OS, Inc.
